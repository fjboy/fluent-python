...
from fp_lib.downloader.urllib import driver as urllib_driver
...
DRIVERS = {
    'wget': 'fp_lib.downloader.wget.driver.WgetDriver',
    'urllib3': 'fp_lib.downloader.urllib.driver.Urllib3Driver'
}
